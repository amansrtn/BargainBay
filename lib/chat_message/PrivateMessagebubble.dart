// ignore_for_file: no_leading_underscores_for_local_identifiers, avoid_print, file_names, unused_import
...
class PrivateMessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Function of ADDING TO PRIVATE CHAT
    return Stack(
      children: [
        Positioned(
          top: 15,
                ...
                children: [
                  ...
                  if (username != null)
                    Padding(
                      ...
                      child: Text(username!, style: textclass.body),
                    ),
