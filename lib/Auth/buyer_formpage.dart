// ignore_for_file: unused_import, camel_case_types, non_constant_identifier_names, avoid_print, unnecessary_new, body_might_complete_normally_nullable, use_build_context_synchronously
...
class _userformState extends State<userform> {
  ...
  savedata() async {
    ...
    await prefs.setString("buyer_Lang", input_lancode);
    await prefs.setString("buyer_Gender", genderval);
    await prefs.setString("buyer_username", fName.text);
    await prefs.setString("buyer_email", email.text);
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Padding(
                  padding: EdgeInsets.only(left: getUnitWidth(context) * 2)),
              const Text(
                "Gender: ",
    ...
    return PopScope(
        ...
        child: Scaffold(
          ...
          body: SingleChildScrollView(
              padding: EdgeInsets.fromLTRB(getUnitWidth(context) * 4,
                  getUnitHeight(context) * 3, getUnitWidth(context) * 7, 0),
              child: SafeArea(
                child: Column(
                  children: [
                    formfield(),
